...
export function createState() {
  return {
    ...
    workspaceDocAuth: [],
    workspaceDocAuthStates: [],
    workspaceDocFiles: [],
    workspaceDocSessions: [],
    workspaceTables: [],
    workspaceTableRows: [],
    notifications: [],
    projectMemories: [],
    ...
    featureFlags: {
      ...
      team_chat_v2_enabled: true,
      mini_threads_enabled: true,
      sidebar_codex_mode_enabled: true,
      folder_automations_v2_enabled: true,
      heartbeat_triggers_enabled: true,
      realtime_ws_enabled: true,
      drawer_tables_enabled: true,
      docs_embed_enabled: true,
      reactions_enabled: true,
      report_templates_v2_enabled: true,
      heartbeat_editor_v2_enabled: true
    },
    modelRuns: [],
    insights: [],
    reports: [],
